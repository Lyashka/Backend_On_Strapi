...
export interface ApiUserProductUserProduct extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::user-product.user-product': ApiUserProductUserProduct;
